...
case $XMONAD in
	...
	pacman -S xmonad xmonad-contrib dmenu nitrogen xmobar cabal-install udisks2 xdotool lxappearance qt5ct pulseaudio pulseaudio-alsa alsa-utils picom gedit pavucontrol doge arandr pcmanfm termite breeze-gtk breeze-icons arc-gtk-theme xorg-xclock xorg-xfontsel xlockmore ttf-ubuntu-font-family atril feh sxiv --noconfirm
